...
local function new_read_buffer(str) return setmetatable({ str = str, loc = 1 }, read_buffer) end
...
---@param bytes string
function write_buffer:write_bytes(bytes) table.insert(self.parts, bytes) end

---@return string
function write_buffer:encode() return table.concat(self.parts) end

local function new_write_buffer() return setmetatable({ parts = {} }, write_buffer) end
